...
const Register = () => {
    ...
    return (
        <div className='bg-gradient-to-r from-indigo-400'>
            <div className="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5 bg-gradient-to-r from-indigo-400">
                <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style={{ maxWidth: "1000px" }}>
                    <div className="md:flex w-full">
                        <div className="hidden md:block w-1/2 bg-gradient-to-r from-indigo-800 py-10 px-10">
